...
public class SwaggerConfig {
	...
	public static ApiInfo metadata() {
		return new ApiInfoBuilder().title("API - Blog da Vitória De Lara").description("Projeto API Spring - Blog Pessoal")
				.version("1.0.0").license("Apache License Version 2.0").licenseUrl("https://github.com/vee2002campos")
				.contact(contact()).build();
	}

	private static Contact contact() {
		return new Contact("Vitória De Lara ", "https://github.com/vee2002campos", "vitoriadelara45@gmail.com");
	}
